...
- **[配对带电谱的保护机制与破缺预算](experiments/protected_threshold_v01/README.md)**：明确一个全局N=1超对称启发完成，消去重场m⁴势而保留电磁阈值，并计入时钟自身F项及共同soft质量。完成五条背景轨迹、270点直接高精度势核验和30点阈值复算；最大预定soft例仍反转。得到可量化的破缺容忍度，但可见区传递、横向稳定和超引力完成尚未解决；没有观测拟合，正式正文未改。
