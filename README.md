...
**中文完整初稿已完成：摘要、第0—9章、参考文献、致谢与研究材料说明，含十四幅矢量图及51条参考文献。** [单栏PDF（71页）](manuscript_cn/paper.pdf)与[章节入口](manuscript_cn/README.md)按原文十章组织。此前七章技术稿继续作为推导与计算来源保留。写作更新日期为2026-09-24；最近一轮科学计算仍为2026-09-22完成的条件算术比较v0.5。本次收尾没有新增实验，下一阶段为整稿修订与重点验证。当前成果是明确的条件模型及数值记录，尚未获得常数演化的观测确认。
