...
当前写作方向：**按原文第0—9章构建中文逐章修订稿，已完成摘要、第0章介绍、第1章物理动机与两张总览图**，入口见[manuscript_cn](manuscript_cn/README.md)。此前摘要、七章正文及三个附录的完整稿作为技术材料保留；其结构不替代原文十章。计算已完成至真实零点残差与替代输入的条件比较v0.5。写作更新日期为2026-09-23；最近一轮计算完成于2026-09-22。当前成果是明确的条件模型与可复现计算，尚未获得常数演化的观测确认。
...
- **[按原文逐章修订：中文累计稿](manuscript_cn/paper.md)**／[PDF（17页）](manuscript_cn/paper.pdf)：已完成摘要、[第0章介绍](manuscript_cn/chapters/00_introduction.md)、[第1章物理动机](manuscript_cn/chapters/01_system_anomaly.md)、两张总览图和24条参考文献。第1章保留原1.1—1.5结构，更新JWST/H0DN与DESI观测背景，融入四个小项目的结果与限制。对应说明见[第0章](manuscript_cn/notes/chapter00_alignment.md)、[第1章](manuscript_cn/notes/chapter01_alignment.md)及[章节总表](manuscript_cn/README.md)。下一步进入第2章。
