...
第1章完成时的累计版本共17页：摘要与两幅矢量图在第1—3页，目录在第4页，第0章在第5—10页，第1章在第11—15页，24条参考文献在第16—17页。当时12个公式标签、24个参考锚点和112个PDF链接通过构建检查，未见缺字或版心溢出；第1章五页的公式和表1.1已目视检查。另核对14个相关Markdown文件的本地链接、全部引用锚点及报告快照哈希。后续[累计PDF](../paper.pdf)随新章节更新，当前页数见[目录](../README.md)。
