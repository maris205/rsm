...
本稿按原文 *The Riemann Standard Model: A Dialogue Between Continuous and Discrete Worldviews* 的总体构建和第0—9章顺序逐章细化。保留原文的研究问题、架构设想和章节分工；在相应位置区分假设、条件推论、数值结果与物理解释。原章各节已按对应说明逐项核对。

“黎曼标准模型”（RSM）沿用原稿自拟名称，指这里提出的假设框架，不表示已经建立与粒子物理标准模型同等地位的理论。工作副标题为“非线性微观动力学与宏观有效规律的条件连接”。

**当前完成：** [中文摘要](abstract.md)、[第0章介绍](chapters/00_introduction.md)、[第1章物理动机](chapters/01_system_anomaly.md)、[第2章算术来源](chapters/02_source_code.md)、[第3章同步架构](chapters/03_cosmic_lockstep.md)、[第4章数学框架](chapters/04_mathematical_framework.md)、[第5章观测约束](chapters/05_observational_evidence.md)、[第6章预测与解释](chapters/06_predictions_interpretations.md)、[第7章引擎设计](chapters/07_engine_design.md)、[第8章模拟验证](chapters/08_simulation_case_studies.md)、[第9章结论](chapters/09_conclusion.md)、[致谢与研究材料说明](acknowledgments.md)、两张[总览图](figures/captions.md)、三张[第2章图](figures/captions_chapter02.md)、一张[第3章图](figures/captions_chapter03.md)、六张[第4章图](figures/captions_chapter04.md)、四张[第5章图](figures/captions_chapter05.md)、一张[第7章图](figures/captions_chapter07.md)及两张[第8章图](figures/captions_chapter08.md)。[完整阅读版](paper.md)和[单栏PDF（86页）](paper.pdf)包含这些内容、目录及63条参考文献。另提供与当前摘要一致的[摘要与图三页版](front_matter.pdf)。第0—9章已齐备，当前状态为中文完整初稿；2026-09-26约定的核心论证收口与导出已完成，章次和本轮修订完成不表示全部科学问题已经解决。

**2026-09-26收口修订：** 第4章自含写出共同哈密顿量，以能流、长波方程、连续动量和条件尾律组织核心论证，并纳入既有64／128／256格点的二阶收敛证据；摘要与第9章使用相同主张。原第0—9章、小节、19幅矢量图及63条参考保留，全稿现为114组唯一编号公式。CMB、引力聚类与冷却保留各自条件，不作为核心命题的额外完成要求。没有新增模拟、数据拟合或文献检索；本轮一致性检查及导出身份见[修订记录](../reports/manuscript_convergence_20260926.md)。下列逐章说明兼含历史记录。
...
[第1章对应说明](notes/chapter01_alignment.md)保留原1.1—1.5的两类物理问题与研究动机，补入JWST/H0DN、DESI更新以及Hubble、α、光谱和CMB项目结果。新增5个公式、一张接口表及11条参考条目；当前观测核查与已有数值结果分开说明。

[第2章对应说明](notes/chapter02_alignment.md)保留原2.1—2.5及三图作用，核对素数与零点前作的实际机制，解释约12.73的条件归一化与平方对数的谱动机，连接已有内部时钟、冻结模态和算术残差对照。新增9个公式、三张重绘图和7条参考条目；没有新增科学实验。
...
[第4章对应说明](notes/chapter04_alignment.md)保留原4.1—4.4及11个三级小节，现有44组编号公式、六幅图、一张尺度表及三行完整反馈收敛表。2026-09-24新增14组公式：有限格点区域能流、连续场动量、三维各向同性无质量波压力、六邻域传播、协方差与薄壳投影；另写明梯度耦合接入时钟所需反作用。[核验归档](../experiments/macro_laws_v01/README.md)含334项守恒/压力和28项波动/传递检查，全部通过；没有新增观测拟合。本次续补图4.3及式(4.16e—g)，保留已有n=0—95数值时间线，并明确暴涨候选的负压、退出及谱检验条件；来源见[时间线归档](../reports/chapter04_timeline_sources/README.md)和[可行性备忘录](../reports/chapter04_inflation_feasibility.md)。新增文献52—54，摘要及结论按各自证据范围同步。 本次续接式(4.16h—k)、图4.4及文献55—57，在另行声明的正则时钟候选中实现有物理年龄的背景与标准引力聚类。[新实验](../experiments/cosmic_bridge_v01/README.md)保留外部初谱、所有8组配对及分辨率限制，星系形成尚未实现。本次续接式(4.16l—n)、图4.5与文献58—62，建立[受控球形塌缩和原初气体冷却接口](../experiments/halo_cooling_v01/README.md)。连续方程和微物理核验通过；三维主配置未过连续精度门限，冷却仍是指定气体状态下的条件估计。2026-09-25续补[匹配粒子／力网格检验](../experiments/pm_matched_scale_v01/README.md)、图4.6及文献63：128/128事件误差0.317%、半径误差3.1266%，后者仍未过3%门限，两档事件差−1.834%未过1%；终态角向力并非单调改善。实现95项、连续参照40项、完整产物审计440项通过，未替代科学精度验收。
...
[第8章对应说明](notes/chapter08_alignment.md)保留原三个案例及9个三级小节，用已归档的α合成恢复、时钟反馈、自主背景和算术控制替代未经支持的预期成功。新增6个公式、三张表和两张结果图，明确幅度检出与形状识别的区别，保留未检出及失败记录；没有新增科学模拟或观测拟合。

[第9章对应说明](notes/chapter09_alignment.md)保留原9.1—9.5和九项比较表，汇总内部时钟、条件尾律、长波连接及检验结果，将可预测性、通信、能源远景落实为物理一致性要求。新增表9.1，没有增加公式、图或文献；摘要作完成状态更新，并补齐原文对应的致谢、AI辅助披露和代码数据说明。

[正文首轮审阅](../reports/manuscript_cn_body_review_20260923.md)覆盖摘要及第0—5章，基准为`ac39f8c`。报告给出逐项定位、证据和最小修正，保留原章节设计；重点包括Hubble扩展的公开复现入口、贡献与候选对应、结果的方法定义及独立论文的组织。该轮为只读科学审阅；该次审阅未改正文，整体修订清单尚未完整执行。此后已补齐第6—9章；本次按用户要求扩充第4章的宏观推导及核验，同步摘要和结论，但不将这项扩充记为既有待办全部完成。
...
| [第1章 System Anomaly](../chapters/02_chapter_01_system_anomaly.md) | 系统异常：物理问题与研究动机 | **已完成[中文稿](chapters/01_system_anomaly.md)**；保留1.1—1.5，更新观测与四个小项目，明确时钟和真空能接口。 |
| [第2章 The Source Code](../chapters/03_chapter_02_source_code.md) | 源代码：算术结构与非自治动力学 | **已完成[中文稿](chapters/02_source_code.md)**；保留2.1—2.5，核对两篇前作与配套代码，重画原三图，说明逆对数平方动机及物理桥接。 |
...
| [第4章 Mathematical Framework](../chapters/05_chapter_04_mathematical_framework.md) | 数学框架：辛演化与离散—连续映射 | **已完成[中文稿](chapters/04_mathematical_framework.md)**；保留4.1—4.4及11个三级小节，给出辛更新、反馈与尾律，并扩充区域守恒、波动压力、CMB传播和统计投影；保留原误差尺度区分。 |
...
| [References](../chapters/11_references.md) | 参考文献 | 已建立[中文稿参考表](references.md)，按当前实际引用纳入63条；原表与技术稿书目继续作为来源。 |
...
python manuscript_cn/figures/make_chapter02_figures.py
