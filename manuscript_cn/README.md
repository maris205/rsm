...
**当前完成：** [中文摘要](abstract.md)、[第0章介绍](chapters/00_introduction.md)、[第1章物理动机](chapters/01_system_anomaly.md)及两张[总览图](figures/captions.md)。[累计阅读版](paper.md)和[单栏PDF（17页）](paper.pdf)包含这些内容、目录及24条参考文献。原[摘要与图的三页版](front_matter.pdf)继续保留。第2—9章尚未在本目录逐章改写；下一步是第2章，不把章节计划计为已完成正文。
...
| [第2章 The Source Code](../chapters/03_chapter_02_source_code.md) | 源代码：算术结构与非自治动力学 | **下一章**；已发表前作、算术输入核查、索引和时间的区别；保留逆对数平方核心假设。 |
...
| [References](../chapters/11_references.md) | 参考文献 | 已建立[中文稿参考表](references.md)，按当前实际引用纳入24条；原表与技术稿书目继续作为来源。 |
